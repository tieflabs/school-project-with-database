...
<head>
	...
	<title>C-Shop ● Newest Products Page</title>
	<link rel="stylesheet" type="text/css" href="style.css">
	<link rel="stylesheet" type="text/css" href="assets/css/nave.css">
	<link rel="stylesheet" type="text/css" href="assets/css/all-categories.css">
	...
	<header class="nav__bar">
         ...
         <!-- Nav Logo -->
			...
			<nav class="navLink__box">
			   <ul>
			     <li><a href="index.php" class="link">Shop</a></li>
			     <li><a href="index.php#product" class="link">Products</a></li>
			     <li><a href="catalog.php" class="link">Catalog</a></li>
			   	 <li><a href="#home" class="link active">New <span>
            ...
            <div class="nav__account-nav__cart-nav__user box flexed">
			        <div class="nav_cart flexed" onclick="cartOpen()"></div>
